...
<div class="index_all" style="text-align:center;">
    <!--上面的背景层-->
    <div>
        <img src="${pageContext.request.contextPath }/application/style/images/flower.gif" />
    </div>
    <!--中间层-->
    <div id="index_center">
        <!--中间层的空白层-->
        ...
        <div>
            ...
            <div class="bg_middle">
                <img
                        src="${pageContext.request.contextPath }/application/style/images/index_menu.gif"
                        border="0" usemap="#Map" />
                <map name="Map" id="Map">
                ...
                <c:choose>
                    <c:when test="${not empty requestScope.table}">
                        <c:forEach var="dt" items="${requestScope.table}">
                            <li>
                                <a href="${pageContext.request.contextPath }/food?method=getMenu&tableId=${dt.id}">
                                        ${dt.tableName }
                                </a>
                            </li>
                        </c:forEach>
