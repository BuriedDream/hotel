...
<div id="StatusBar">
    ...
    <div id="StatusBar_Links">
		<a href="http://www.gluttonous.cn" target="_blank">欢迎联系 Liam</a>，
    </div>
	<!-- 右侧功能按钮 -->
    <div id="StatusBar_Right">
		<!-- 版本 -->
		<a href="javascript:void(0)">
			<img border="0" width="11" height="11" src="${pageContext.request.contextPath}/system/style/images/info.gif" />
			<img border="0" width="40" height="11" src="${pageContext.request.contextPath}/system/style/images/version.gif" />
		</a>
    </div>
</div>
