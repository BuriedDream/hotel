...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
			...
			<img border="0" width="13" height="13" src="${pageContext.request.contextPath}/system/style/images/title_arrow.gif"/> 更新新菜品
            ...
            <div class="ItemBlock">
				<div class="ItemBlock2">
                    ...
                    <tr>
                        ...
                        <tr>
							<td>会员价格</td>
							<td><input type="text" name="memberPrice" class="InputStyle" value="${requestScope.food.memberPrice}"/> *</td>
						</tr>
						...
						<tr>
							...
							<td>
								<img style='max-width:68px;width:68px; width:expression(width>68 ? "68px":width "px");max-width: 68px;' src="${pageContext.request.contextPath}/image/${requestScope.food.image}">
								<input type="hidden" name="image" value="${requestScope.food.image}">
