	...
	<div id="MainArea">
		<table class="MainArea_Content" align="center" cellspacing="0" cellpadding="0">
			...
			<tbody id="TableData">
			     <c:choose>
                     <c:when test="${not empty requestScope.foodTypeList}">
                         <c:forEach var="foodType" items="${requestScope.foodTypeList}">
                             <tr>
                                 ...
                                 <td align="center">
                                     <a href="${pageContext.request.contextPath}/foodType?id=${foodType.id}&method=updateView" class="FunctionButton">更新</a>
                     ...
                     <c:otherwise>
                         <tr>
                             <td colspan="3" align="center">暂时还没有菜系，请先增加些菜系！</td>
                         </tr>
                     </c:otherwise>
				 </c:choose>
		...
		<div id="TableTail" align="center">
			<div class="FunctionButton">
				<a href="${pageContext.request.contextPath}/system/foodType/saveCuisine.jsp">添加</a>
			</div>
		</div>
	</div>
</body>
